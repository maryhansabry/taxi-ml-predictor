import { a0 as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-BBLD3qyQ.js";
import { L as Link, t as toast } from "./router-Cg_aAj9c.js";
import { c as createLucideIcon, b as clsx, A as AppShell, P as PageHeader, Z as Zap, S as Sparkles, B as Brain, d as cn, a as api } from "./AppShell-DYzb_3YL.js";
...
function ModelsPage() {
  ...
  const [mode, setMode] = reactExports.useState("pretrained");
  const [results, setResults] = useSessionState("models", null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { eyebrow: "Step 03 · Model Hub", title: "Pretrained or freshly trained — your call", description: "Load production-ready GBT, RF, and XGBoost weights, or kick off a fresh Spark training run on your dataset." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 py-10 space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModeCard, { active: mode === "pretrained", onClick: () => setMode("pretrained"), icon: Zap, title: "Pretrained", tag: "Default · Fast", desc: "Use the GBT, RF, and XGBoost models already trained on the full NYC dataset. Instant results." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModeCard, { active: mode === "train", onClick: () => setMode("train"), icon: Cpu, title: "Train from scratch", tag: "Spark · Heavy", desc: "Run the Spark pipeline on your uploaded data. Splits, fits, evaluates and picks the best model." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card p-8 shadow-card", children: mode === "pretrained" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Upload a Spark PipelineModel ZIP file (must contain metadata/ and stages/)." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: loadPretrained, disabled: busy, className: "inline-flex items-center gap-2 rounded-lg bg-gradient-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow disabled:opacity-50", children: busy ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-semibold flex items-center gap-2", children: [
            ...
            " Train RF · GBT · XGBoost"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: preview ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            "Dataset: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground", children: preview.dataset_id.slice(0, 8) }),
            " · ",
            preview.rows.toLocaleString(),
            " rows"
          ] }) : "No dataset loaded — upload first." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: train, disabled: busy || !preview, className: "inline-flex items-center gap-2 rounded-lg bg-gradient-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow disabled:opacity-50", children: busy ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
          " Training…"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      results && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-primary/40 bg-gradient-hero p-6 grid-pattern relative overflow-hidden shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-14 w-14 place-items-center rounded-xl bg-gradient-primary shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-7 w-7 text-primary-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Best model" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold tracking-tight mt-0.5", children: results.best_model }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground mt-1", children: [
              "Selected by lowest RMSE across ",
              results.metrics.length,
              " candidates · ",
              results.mode === "pretrained" ? "Pretrained" : "Freshly trained"
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 border-b border-border bg-secondary/30 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-4 w-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Comparison" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-left font-medium", children: "Model" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-right font-medium", children: "RMSE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-right font-medium", children: "MAE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-right font-medium", children: "R²" }),
              results.metrics.some((m) => m.train_seconds) && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-5 py-3 text-right font-medium", children: "Train time" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: results.metrics.map((m) => {
              const best = m.model === results.best_model;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: cn("border-b border-border/50", best && "bg-primary/5"), children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  best && /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-3.5 w-3.5 text-primary" }),
                  m.model
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right font-mono", children: m.rmse.toFixed(2) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right font-mono", children: m.mae.toFixed(2) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right font-mono", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: best ? "text-primary font-semibold" : "", children: m.r2.toFixed(3) }) }),
                results.metrics.some((x2) => x2.train_seconds) && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-right font-mono text-muted-foreground", children: m.train_seconds ? `${m.train_seconds.toFixed(1)}s` : "—" })
              ] }, m.model);
            }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "RMSE & MAE (lower is better)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: results.metrics, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.30 0.022 250)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "model", stroke: "oklch(0.70 0.02 250)", fontSize: 12 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.70 0.02 250)", fontSize: 12 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
              background: "oklch(0.21 0.022 250)",
              border: "1px solid oklch(0.30 0.022 250)",
              borderRadius: 8
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "rmse", fill: "oklch(0.86 0.17 92)", radius: [6, 6, 0, 0] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "mae", fill: "oklch(0.65 0.18 250)", radius: [6, 6, 0, 0] })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "R² Score (higher is better)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: results.metrics, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.30 0.022 250)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "model", stroke: "oklch(0.70 0.02 250)", fontSize: 12 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.70 0.02 250)", fontSize: 12, domain: [0, 1] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
              background: "oklch(0.21 0.022 250)",
              border: "1px solid oklch(0.30 0.022 250)",
              borderRadius: 8
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "r2", radius: [6, 6, 0, 0], children: results.metrics.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: m.model === results.best_model ? "oklch(0.72 0.18 155)" : "oklch(0.65 0.18 250)" }, m.model)) })
          ] }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/predict", className: "inline-flex items-center gap-2 rounded-lg bg-gradient-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow", children: [
          "Use ",
          results.best_model,
          " to predict ",
...
function ModeCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick, className: cn("text-left rounded-2xl border p-6 transition relative overflow-hidden", active ? "border-primary/60 bg-primary/5 shadow-glow" : "border-border bg-card hover:border-primary/30"), children: [
    active && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3 h-2 w-2 rounded-full bg-primary shadow-glow" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("grid h-10 w-10 place-items-center rounded-lg", active ? "bg-gradient-primary" : "bg-secondary"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-5 w-5", active ? "text-primary-foreground" : "text-foreground") }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-muted-foreground border border-border rounded-full px-2 py-0.5", children: tag })
    ] }),
...
function ChartCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold mb-4", children: title }),
    children
  ] });
}
export {
