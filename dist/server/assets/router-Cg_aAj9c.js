...
const appCss = "/assets/styles-DM-tO_mI.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:opacity-90", children: "Go home" }) })
  ] }) });
}
...
const $$splitComponentImporter$4 = () => import("./upload-8lx3pcXJ.js");
const Route$4 = createFileRoute("/upload")({
  head: () => ({
    meta: [{
      title: "Upload — TaxiML"
    }]
...
const $$splitComponentImporter$3 = () => import("./preprocess-DglzGVmD.js");
const Route$3 = createFileRoute("/preprocess")({
  head: () => ({
    meta: [{
      title: "Preprocessing — TaxiML"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./predict-CzBzoojt.js");
const Route$2 = createFileRoute("/predict")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./models-wDf_rqTe.js");
const Route$1 = createFileRoute("/models")({
  head: () => ({
    meta: [{
      title: "Model Hub — TaxiML"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-e--w3dNr.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const UploadRoute = Route$4.update({
  id: "/upload",
  path: "/upload",
  getParentRoute: () => Route$5
});
const PreprocessRoute = Route$3.update({
  id: "/preprocess",
  path: "/preprocess",
  getParentRoute: () => Route$5
});
const PredictRoute = Route$2.update({
  id: "/predict",
  path: "/predict",
  getParentRoute: () => Route$5
});
const ModelsRoute = Route$1.update({
  id: "/models",
  path: "/models",
  getParentRoute: () => Route$5
});
